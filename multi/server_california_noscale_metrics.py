...
print("==== California No-Scale Distributed Loss History ====")
print(losses)

print("==== California No-Scale Distributed Metrics History ====")
print(metrics)
...
# CSV保存
# =========================
with open("federated_metrics_california_noscale.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
print("Saved: federated_metrics_california_noscale.csv")
...
if len(rounds) > 0:
    ...
    plt.xlabel("Round")
    plt.ylabel("MSE")
    plt.title("California No-Scale MSE")
    plt.grid(True)
    ...
    plt.xlabel("Round")
    plt.ylabel("RMSE")
    plt.title("California No-Scale RMSE")
    plt.grid(True)
    ...
    plt.xlabel("Round")
    plt.ylabel("MAE")
    plt.title("California No-Scale MAE")
    plt.grid(True)
    ...
    plt.xlabel("Round")
    plt.ylabel("R2")
    plt.title("California No-Scale R2")
    plt.grid(True)

    plt.tight_layout()
    plt.savefig("federated_metrics_california_noscale.png", dpi=300)

    print("Saved: federated_metrics_california_noscale.png")
