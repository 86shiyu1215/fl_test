...
print("==== Distributed Metrics History ====")
print(metrics)
...
# CSV保存
# =========================
with open("federated_metrics_multi.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
print("Saved: federated_metrics_multi.csv")
...
if len(rounds) > 0:
    ...
    plt.tight_layout()
    plt.savefig("federated_metrics_multi.png", dpi=300)

    print("Saved: federated_metrics_multi.png")
