...
print("==== California Scaled Distributed Loss History ====")
print(losses)

print("==== California Scaled Distributed Metrics History ====")
print(metrics)
...
# CSV保存
# =========================
with open("federated_metrics_california.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
print("Saved: federated_metrics_california.csv")
...
if len(rounds) > 0:
    ...
    plt.xlabel("Round")
    plt.ylabel("MSE")
    plt.title("California Scaled MSE")
    plt.grid(True)
    ...
    plt.xlabel("Round")
    plt.ylabel("RMSE")
    plt.title("California Scaled RMSE")
    plt.grid(True)
    ...
    plt.xlabel("Round")
    plt.ylabel("MAE")
    plt.title("California Scaled MAE")
    plt.grid(True)
    ...
    plt.xlabel("Round")
    plt.ylabel("R2")
    plt.title("California Scaled R2")
    plt.grid(True)

    plt.tight_layout()
    plt.savefig("federated_metrics_california.png", dpi=300)

    print("Saved: federated_metrics_california.png")
